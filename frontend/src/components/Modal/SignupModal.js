...
const SignupModal = ({ isOpen, onClose }) => {
  ...
  const handleRoleSelect = async (role) => {
    try {
      ...
      if (role === 'client' || user.userType === 'buyer') {
        navigate('/gigs');
      } else {
        navigate('/dashboard');
      }
      ...
      <div className="modal-container" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="modal-content">
          ...
          <div className="modal-left">
            <h2 className="modal-left-title">Success starts here</h2>
          ...
          <div className="modal-right">
            <h2 className="modal-right-title">Create a new account</h2>
            ...
            <p className="modal-legal">
              By Joining, you agree to the HunarmandPro{' '}
              <a href="#" className="legal-link">Terms of Service</a> and to occasionally receive emails from us. Please read our{' '}
              <a href="#" className="legal-link">Privacy Policy</a> to learn how we use your personal data.
            </p>
          </div>
        </div>
      </div>
  ...
  return (
    <>
      ...
      <RoleSelectionModal
        ...
        username={selectedUsername || email.split('@')[0]}
      />
    </>
  );
};
